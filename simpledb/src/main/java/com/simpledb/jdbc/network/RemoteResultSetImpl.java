...
class RemoteResultSetImpl extends UnicastRemoteObject implements RemoteResultSet {
    ...
    * @see com.simpledb.jdbc.network.RemoteResultSet#next()
    */
    ...
    * @see com.simpledb.jdbc.network.RemoteResultSet#getInt(java.lang.String)
    */
    ...
    * @see com.simpledb.jdbc.network.RemoteResultSet#getMetaData()
    */
    ...
    * @see com.simpledb.jdbc.network.RemoteResultSet#close()
    */
