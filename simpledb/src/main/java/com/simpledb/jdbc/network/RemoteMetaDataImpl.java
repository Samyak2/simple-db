package com.simpledb.jdbc.network;
...
public class RemoteMetaDataImpl extends UnicastRemoteObject implements RemoteMetaData {
    ...
    * @see com.simpledb.jdbc.network.RemoteMetaData#getColumnCount()
    */
    ...
    * @see com.simpledb.jdbc.network.RemoteMetaData#getColumnName(int)
    */
    ...
    * @see com.simpledb.jdbc.network.RemoteMetaData#getColumnType(int)
    */
    ...
    * @see com.simpledb.jdbc.network.RemoteMetaData#getColumnDisplaySize(int)
    */
