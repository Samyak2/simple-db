...
class RemoteStatementImpl extends UnicastRemoteObject implements RemoteStatement {
    ...
    * @see com.simpledb.jdbc.network.RemoteStatement#executeQuery(java.lang.String)
    */
    ...
    * which executes it.
    * @see com.simpledb.jdbc.network.RemoteStatement#executeUpdate(java.lang.String)
    */
