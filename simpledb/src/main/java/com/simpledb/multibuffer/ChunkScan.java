package com.simpledb.multibuffer;
...
public class ChunkScan implements Scan {
   ...
   /**
    * @see com.simpledb.query.Scan#close()
    */
   public void close() {
   ...
   /**
    * @see com.simpledb.query.Scan#beforeFirst()
    */
    ...
    * @see com.simpledb.query.Scan#next()  
    */
   public boolean next() {
   ...
   /**
    * @see com.simpledb.query.Scan#getInt(java.lang.String)
    */
   ...
   /**
    * @see com.simpledb.query.Scan#getString(java.lang.String)
    */
   ...
   /**
    * @see com.simpledb.query.Scan#getVal(java.lang.String)
    */
  ...
  /**
    * @see com.simpledb.query.Scan#hasField(java.lang.String)
    */
