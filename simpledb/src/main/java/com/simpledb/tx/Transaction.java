...
import com.simpledb.file.*;
import com.simpledb.log.LogMgr;
import com.simpledb.buffer.*;
import com.simpledb.tx.recovery.*;
import com.simpledb.tx.concurrency.ConcurrencyMgr;
...
public class Transaction {
    ...
    * {@link com.simpledb.server.SimpleDB}.
    * Those objects are created during system initialization.
    * Thus this constructor cannot be called until either
    * {@link com.simpledb.server.SimpleDB#init(String)} or 
    * {@link com.simpledb.server.SimpleDB#initFileLogAndBufferMgr(String)} or
    * is called first.
    */
